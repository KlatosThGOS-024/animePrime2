...
const getAnimeFromJSON = () => {
    try {
        const filePath = path_1.default.join(__dirname, "Anime.json");
        let animeList = [];
...
const saveAmimeCard = (0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const saveAnimeCard = yield db_1.default.animeCard.createMany({
        ...
        res.send(new ApiError_1.ApiError("Something went wrong", 400));
    }
}));
